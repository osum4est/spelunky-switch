...
if (status == GET_FILE_NAME)
{
    ...
    draw_text(__view_get( e__VW.XView, 0 )+40, __view_get( e__VW.YView, 0 )+96, string_hash_to_newline(global.Levels));
    ...
    if (msgTimer > 0)
    {
        ...
        draw_text(__view_get( e__VW.XView, 0 )+32, __view_get( e__VW.YView, 0 )+224, string_hash_to_newline(global.NoSuchLevelExists));
    }
    else draw_text(__view_get( e__VW.XView, 0 )+32, __view_get( e__VW.YView, 0 )+224, string_hash_to_newline(global.PressEscapeToReturnToTitle));
    draw_set_color(c_white);
    n = 112;
    m = 0;
    i = (page-1)*10;
