...
if (status == IDLE or status == FOLLOW)
{
    if (oPlayer1.holdItem > 0)
    {
        ...
        if (item.cost > 0)
        {
            ...
            if (global.gamepadOn) global.message2 = global.Press + scrGetJoy(global.joyPayVal) + global.ToPurchase;
            else global.message2 = global.Press + scrGetKey(global.keyPayVal) + global.ToPurchase;
...
if (status == IDLE)
{
    ...
    {
        if (style == global.Bomb) global.message = global.WelcomeTo + scrGetName() + global.SBombShop;
        else if (style == "Weapon") global.message = global.WelcomeTo + scrGetName() + global.SArmory;
        else if (style == "Clothing") global.message = global.WelcomeTo + scrGetName() + global.SClothingShop;
        else if (style == "Rare") global.message = global.WelcomeTo + scrGetName() + global.SSpecialityShop;
        else if (style == "Craps") global.message = global.WelcomeTo + scrGetName() + global.SDiceHouse;
        else if (style == "Kissing") global.message = global.WelcomeTo + scrGetName() + global.SKissingParlor;
        else if (style == "Ankh") global.message = global.IHaveSomethingSpecial;
        else global.message = global.WelcomeTo + scrGetName() + global.SSupplyShop;
        if (style == "Craps")
        {
            if (global.gamepadOn) global.message2 = global.Press + scrGetJoy(global.joyPayVal) + global.ToBetS + string(betValue) + ".";
            else global.message2 = global.Press + scrGetKey(global.keyPayVal) + global.ToBetS + string(betValue) + ".";
        }
        else if (style == "Kissing")
        {
            if (global.gamepadOn) global.message2 = "$" + string(getKissValue()) + global.AKissPress + scrGetJoy(global.joyPayVal) + ".";
            else global.message2 = "$" + string(getKissValue()) + global.AKissPress + scrGetKey(global.keyPayVal) + ".";
        }
    ...
    if (style == "Craps")
    {
        ...
        if (global.diceRolled)
        {
            if (global.diceValue == 7)
            {
                ...
                global.message = global.YouRolledASeven;
                global.message2 = global.YouWonAPrize;
                global.messageTimer = 200;
                oPlayer1.bet = 0;
                with oItem
                {
            ...
            {
                if (isRealLevel()) global.diceGamesWon += 1;
                global.message = global.YouRolledA + string(global.diceValue) + "!";
                global.message2 = global.CongratulationsYouWin;
                global.messageTimer = 200;
            ...
            else if (global.diceValue < 7)
            {
                ...
                global.message = global.YouRolledA + string(global.diceValue) + "!";
                global.message2 = global.ImSorryButYouLose;
                global.messageTimer = 200;
                oPlayer1.bet = 0;
            }
            global.diceRolled = false;
