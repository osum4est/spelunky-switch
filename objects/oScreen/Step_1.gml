...
{   
    ...
    //draw_surface_stretched(pSurf,screen_x,screen_y,global.display_w*screen_scale,global.display_h*screen_scale);
    ...
    //draw_surface_stretched(pSurf,screen_x,screen_y,global.display_w,global.display_h);
}
else
{
    if (isRoom("rTitle"))
    ...
    if view_current=0
    {
        ...
        draw_surface_stretched(screen,screen_x,screen_y,global.display_w*screen_scale,global.display_h*screen_scale);
