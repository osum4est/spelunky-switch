...
if (paused)
{
    ...
    draw_text(112, 200, global.Paused);
    ...
    if (isLevel())
    {
        ...
        else draw_text(40, n-24, global.Level + string(global.currLevel));
        draw_text(40, n-16, "DEPTH: " + string(174.8*(global.currLevel-1)+(py+8)*0.34) + " FEET");
        draw_text(40, n, global.Money2 + string(global.money));
        draw_text(40, n+8, global.Kills2 + string(global.kills));
        s = global.xtime;
        s = floor(s / 1000);
        m = 0;
        while (s > 59)
        ...
        draw_text(40, n+16, global.Time2 + string(m) + ":" + str + " / " + string(m2) + ":" + str2);
    ...
    if (isRoom("rTitle"))
    {
       draw_set_alpha(oTitle.darkness);
        ...
        if (oTitle.state == 1)
        {
            draw_set_font(global.myFontSmall);
            draw_set_color(c_white);
            draw_text(88, 48, global.DerekYuPresents);
        }
        draw_set_alpha(1);
    }
}
